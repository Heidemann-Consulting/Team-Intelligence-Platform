...
-- Template: LACM_WeeklyPlanPreview_Initial
DO $$
DECLARE
    template_item_id uuid := public.uuid_generate_v4();
    template_version_id uuid := public.uuid_generate_v4();
...
-- Template: LACM_PrioritizedInnovationInitiatives
DO $$
DECLARE
    template_item_id uuid := public.uuid_generate_v4();
    template_version_id uuid := public.uuid_generate_v4();
...
-- Template: LACM_CustomerFeedback
DO $$
DECLARE
    template_item_id uuid := public.uuid_generate_v4();
    template_version_id uuid := public.uuid_generate_v4();
...
-- Template: LACM_WeeklyRetroSummary
DO $$
DECLARE
    template_item_id uuid := public.uuid_generate_v4();
    template_version_id uuid := public.uuid_generate_v4();
...
-- Template: LACM_MeetingSummary
-- This name might conflict with a general "Meeting Summary" template if one exists from other files.
-- Adding "LACM_" prefix to ensure it's specific to this library's context.
DO $$
DECLARE
    template_item_id uuid := public.uuid_generate_v4();
    template_version_id uuid := public.uuid_generate_v4();
